"""
Django settings for devops-try project.
...
LOCALE_PATHS = (BASE_ROOT / "locale",)

SITE_ID = 1

CACHES = {"default": env.cache_url("DJANGO_CACHE_URL", "dummycache://127.0.0.1")}
